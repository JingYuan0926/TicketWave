            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="text-default-600">{concert.additionalInfo}</p>
                </CardBody>
              </Card>
            </div>
                  ...
                  >
                    {({ open }) => (
                      <Button
                        ...
                        size="lg"
                        className="w-full"
                        disabled={!selectedTicketType || !wallet?.address}
                        onClick={() => {
                          if (!wallet?.address) {
                ...
                {transactionStatus === "pending" && (
                  <>
                    ...
                    <div className="p-4 bg-default-100 rounded-lg">
                      ...
                      <p>
                        Price: ${concert.price[selectedTicketType].toFixed(2)}
                      </p>
                    </div>
                  </>
                )}
